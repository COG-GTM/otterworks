...
Reference implementations: the SNS share-notification failure
(`FILE_SHARE_EVENT_ALWAYS_FAIL`, PR #209) and the SQS consumer failure
(`NOTIFICATION_SQS_ALWAYS_FAIL`). Companion skill `purposeful-failure-devin-trigger` covers how the
