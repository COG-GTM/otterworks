...
> **Note:** The Report Service was migrated from Java 8 / Spring Boot 2.5 / JUnit 4 / `javax.*` to Java 17 / Spring Boot 3.2 / JUnit 5 / `jakarta.*`. See `services/report-service/UPGRADE_GUIDE.md` for the axes covered and the remaining follow-ups.
