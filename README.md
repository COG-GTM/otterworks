...
> **Note:** The Report Service was migrated from Java 8 / Spring Boot 2.5 to Java 17 / Spring Boot 3.2 (jakarta namespaces, JUnit 5, springdoc-openapi). Remaining tech debt is tracked in `services/report-service/UPGRADE_GUIDE.md`.
