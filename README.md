...
> **Note:** The Report Service was migrated from Java 8 / Spring Boot 2.5 to Java 17 / Spring Boot 3.2; see `services/report-service/UPGRADE_GUIDE.md` for the record of that migration.
