...
> **Note:** The Report Service was migrated from Java 8 / Spring Boot 2.5 / JUnit 4 / `javax.*` to
> Java 17 / Spring Boot 3.2 / JUnit 5 / `jakarta.*`. Remaining dependency upgrades (iText, POI,
> Guava, Commons IO, OpenCSV) are tracked in `services/report-service/UPGRADE_GUIDE.md`.
