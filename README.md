...
> **Note:** The Report Service was upgraded from Java 8 / Spring Boot 2.5 to Java 17 / Spring Boot 3.2 (jakarta.\*, JUnit 5, springdoc). See `services/report-service/UPGRADE_GUIDE.md` for the migration path.
