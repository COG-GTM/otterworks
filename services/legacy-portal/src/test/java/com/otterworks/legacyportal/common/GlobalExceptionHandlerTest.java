...
class GlobalExceptionHandlerTest {
    ...
    @Test
    void missingResourceBecomes404WithReasonPhraseAndMessage() {
    ...
    @Test
    void invalidArgumentBecomes400WithReasonPhraseAndMessage() {
        ResponseEntity<Map<String, String>> response =
    ...
    @Test
    void bodyKeepsErrorBeforeMessageAndToleratesANullMessage() {
        ResponseEntity<Map<String, String>> response =
                handler.handleNotFound(new NoSuchElementException());

        assertThat(response.getBody()).containsExactly(
                org.assertj.core.data.MapEntry.entry("error", "Not Found"),
                org.assertj.core.data.MapEntry.entry("message", null));
    }
}
