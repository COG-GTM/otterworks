...
class HealthControllerTest {
  ...
  @Test
  void health_shouldReportHealthyWhenTheConnectionIsValid() throws SQLException {
  ...
  @Test
  void health_shouldReportDegradedWhenTheConnectionIsInvalid() throws SQLException {
    when(dataSource.getConnection()).thenReturn(connection);
  ...
  @Test
  void health_shouldReportDegradedWhenTheDataSourceThrows() throws SQLException {
