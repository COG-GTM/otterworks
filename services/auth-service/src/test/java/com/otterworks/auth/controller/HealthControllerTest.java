...
class HealthControllerTest {
  ...
  @Test
  void reportsHealthyWhenTheConnectionValidates() throws SQLException {
  ...
  @Test
  void reports503WhenTheConnectionIsNotValid() throws SQLException {
    when(dataSource.getConnection()).thenReturn(connection);
  ...
  @Test
  void reports503WhenTheDataSourceCannotHandOutAConnection() throws SQLException {
  ...
  @Test
  void reports503WhenValidationItselfFails() throws SQLException {
    when(dataSource.getConnection()).thenReturn(connection);
    when(connection.isValid(3)).thenThrow(new SQLException("timeout"));
