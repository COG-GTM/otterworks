...
pub async fn upload_file(
    ...
    // CHAOS: when the Redis chaos flag is active, the S3 client targets a
    // nonexistent bucket, simulating a misconfigured bucket name after a recent
    // infra change.  The AWS SDK returns NoSuchBucket which surfaces as a 500.
