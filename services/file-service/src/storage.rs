...
impl S3Client {
    ...
    pub async fn download_object(&self, key: &str) -> Result<Bytes, ServiceError> {
        let resp = self
            ...
            .send()
            .await
            .map_err(|e| s3_error("download failed", e))?;

        let body = resp
            .body
            .collect()
            .await
            .map_err(|e| s3_error("body read failed", e))?;
    ...
    pub async fn presigned_download_url(
        ...
        let presigned = self
            ...
            .await
            .map_err(|e| s3_error("presign failed", e))?;
    ...
    pub async fn delete_object(&self, key: &str) -> Result<(), ServiceError> {
        self.client
            ...
            .send()
            .await
            .map_err(|e| s3_error("delete failed", e))?;
    ...
    pub async fn copy_object(&self, source_key: &str, dest_key: &str) -> Result<(), ServiceError> {
        ...
        self.client
            ...
            .send()
            .await
            .map_err(|e| s3_error("copy failed", e))?;
