  ...
  module V1
    module Admin
      class ChaosController < ApplicationController
        ...
        # Services whose open incidents a reset should resolve. Broader than the
        # chaos scenarios: any service that raises alerts can leave an incident
        # behind (e.g. file-service upload failures).
        INCIDENT_SERVICES = (VALID_SCENARIOS.keys + ['file-service']).uniq.freeze
