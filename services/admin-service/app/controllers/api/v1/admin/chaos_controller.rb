  ...
  module V1
    module Admin
      class ChaosController < ApplicationController
        ...
        # Services whose open incidents a reset clears. Broader than the chaos
        # scenarios above: file-service incidents come from real upload alerts and
        # must still be resolved, or the dedup guard suppresses every later one.
        RESET_SERVICES = (VALID_SCENARIOS.keys + ['file-service']).uniq.freeze
