...
describe('loadConfig', () => {
  ...
  it('reads every setting from the environment when provided', () => {
    ...
    process.env.OTEL_SERVICE_NAME = 'collab-canary';
  ...
  it('parses a single CORS origin into a one-element list', () => {
