...
/**
 * OpenAPI 3 metadata for springdoc-openapi. The spec itself is generated from the
 * controller and model annotations; only the document-level info is declared here.
 */
@Configuration
public class SwaggerConfig {

    @Bean
    public OpenAPI reportServiceApi() {
