 ...
 *
 * REMAINING TECH DEBT:
 * - Uses RestTemplate; target WebClient (reactive) or RestClient (Spring 6.1+)
 */
@Configuration
public class AppConfig {
    ...
    public RestTemplate restTemplate() {
        ...
        // HttpClient 5 carries the socket read timeout on the connection manager,
        // not on Spring's request factory.
