...
public class ExcelReportGeneratorTest {
    ...
    public void generatedExcelHasSummaryAndDataSheets() throws IOException {
        ...
        try (FileInputStream fis = new FileInputStream(xlsx);
            ...
            assertEquals("Summary",
                    workbook.getSheetName(0), "First sheet should be 'Summary'");
            assertEquals("Data",
                    workbook.getSheetName(1), "Second sheet should be 'Data'");
        }
    }
    ...
    public void summarySheetContainsReportMetadata() throws IOException {
        ...
        try (FileInputStream fis = new FileInputStream(xlsx);
            ...
            assertEquals("OtterWorks Report",
                    titleRow.getCell(0).getStringCellValue(), "Title should be 'OtterWorks Report'");
            ...
            assertEquals(7.0,
                    countRow.getCell(1).getNumericCellValue(), 0.001, "Row count should match data size");
        }
    }
    ...
    public void dataSheetContainsCorrectNumberOfRows() throws IOException {
        ...
        try (FileInputStream fis = new FileInputStream(xlsx);
            ...
            assertEquals(expectedRows + 1,
                    dataSheet.getPhysicalNumberOfRows(), "Data sheet should have header + data rows");
        }
    }
