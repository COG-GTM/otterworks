...
public class PdfReportGeneratorTest {
    ...
    public void generatePdfWithMultipleRowsProducesLargerFile() throws IOException {
        ...
        assertTrue(
                largePdf.length() > smallPdf.length(), "Larger dataset should produce a larger PDF");
    }
    ...
    public void generatePdfFileNameContainsReportName() throws IOException {
        ...
        assertTrue(
                pdf.getName().startsWith("quarterly_audit_summary_"), "File name should contain sanitized report name");
    }
