 ...
 *
 * The async generation worker is mocked out so a created report stays in its
 * initial state for the duration of a test; otherwise background generation
 * can move a report out of PENDING between two requests.
 */
@SpringBootTest
