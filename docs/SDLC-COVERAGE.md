...
| **Legacy modernization** | §13, §2 (report-service Java 8 → 17) | Cron ETL is a ready-made "before" state; `report-service` has since been migrated to Java 17 / Spring Boot 3.2 |
