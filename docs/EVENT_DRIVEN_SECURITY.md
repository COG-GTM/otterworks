...
| Trivy excluded dirs | `services/report-service` | Exclusion predates the Java 17 / Boot 3 migration; re-enable is a follow-up |
...
| report-service | Java 17 | `pom.xml` | **Excluded** (re-enable pending) |
