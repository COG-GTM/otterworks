...
| Trivy excluded dirs | `services/report-service` | Excluded historically as a legacy Java 8 service; now on Java 17 / Spring Boot 3.2 |
...
| report-service | Java 17 | `pom.xml` | **Excluded** (scan exclusion predates the Java 17 migration) |
