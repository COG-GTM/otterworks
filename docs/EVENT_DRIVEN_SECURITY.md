...
| Trivy excluded dirs | `services/report-service` | Excluded during the Java 17 upgrade track; revisit now that it is on Boot 3.2 |
...
| report-service | Java 17 | `pom.xml` | **Excluded** (upgrade track; exclusion pending review) |
