...
**Note:** report-service is intentionally excluded from scans. It is tracked on a separate framework-upgrade track (now Java 17 / Spring Boot 3.2) and is not in scope for this sprint.
