...
**Note:** report-service is excluded from scans. It was earmarked for a separate framework upgrade exercise (now on Java 17 / Spring Boot 3.2) and is not in scope for this sprint.
