...
**Note:** report-service is intentionally excluded from scans and is not in scope for this sprint. Its Java 17 / Spring Boot 3.2 upgrade was handled on a separate track.
