...
3. **Legacy service isolation** — Trivy still skips `services/report-service` via `--skip-dirs`. That exclusion predates the Java 17 / Spring Boot 3.2 upgrade and should be dropped in a follow-up.
