...
3. **Report service scan exclusion** — Report service is still skipped by Trivy; now that it runs Java 17 / Spring Boot 3.2 with current dependencies, that exclusion should be revisited.
