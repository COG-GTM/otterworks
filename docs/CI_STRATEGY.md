...
3. **Legacy service isolation** — Report service is skipped by Trivy; it now builds on Java 17 / Spring Boot 3.2 but keeps some intentionally outdated dependencies for upgrade exercises.
