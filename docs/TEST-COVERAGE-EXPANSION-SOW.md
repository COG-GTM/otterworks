...
**Repo:** `COG-GTM/otterworks` @ `b20c699` · **Date:** 2026-08-06 · **Status:** plan only, no code written.
...
> Execute **`<WP-ID>`** from `docs/TEST-COVERAGE-EXPANSION-SOW.md` in `COG-GTM/otterworks`.
