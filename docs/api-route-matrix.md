...
| Comments | `POST /api/v1/documents/{id}/comments`, `GET /api/v1/documents/{id}/comments?include_resolved=`, `POST /api/v1/documents/{id}/comments/{comment_id}/resolve`, `POST /api/v1/documents/{id}/comments/{comment_id}/unresolve`, `DELETE /api/v1/documents/{id}/comments/{comment_id}` | `tests/api/test_document_flow.py` (resolve/unresolve not yet covered there) |
